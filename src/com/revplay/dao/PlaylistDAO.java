...
public class PlaylistDAO {
    ...
    public List<String> viewMyPlaylists(int userId) {
        ...
        String sql =
            "SELECT playlist_id, playlist_name, privacy, created_at " +
            "FROM playlists " +
            "WHERE user_id=? " +
    ...
    public boolean addSongToPlaylist(int playlistId, int songId) {
        ...
        try {
            ...
            System.out.println(
                    "Song already in playlist OR invalid playlist/song id.");
            return false;
    ...
    public List<String> viewPlaylistSongs(int playlistId) {
        ...
        String sql =
            "SELECT s.song_id, s.title, u.name AS artist_name, s.genre " +
    ...
    public List<String> viewPublicPlaylists(int currentUserId) {
        ...
        String sql =
            "SELECT p.playlist_id, p.playlist_name, u.name AS owner_name, p.created_at " +
            "FROM playlists p " +
